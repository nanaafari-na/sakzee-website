...
const inp: React.CSSProperties = { width: '100%', padding: '0.75rem 1rem', border: '1.5px solid #e2e8f0', borderRadius: '8px', fontSize: '0.95rem', outline: 'none', boxSizing: 'border-box' as const, fontFamily: 'inherit', color: '#1a2456', background: 'white' };
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                <input style={{ ...inp, paddingRight: '2.75rem' }} name="password" type={showPassword ? 'text' : 'password'} value={form.password} onChange={handleChange} placeholder="Minimum 8 characters" />
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                <input style={{ ...inp, paddingRight: '2.75rem' }} name="confirm_password" type={showConfirm ? 'text' : 'password'} value={form.confirm_password} onChange={handleChange} placeholder="Repeat your password" />

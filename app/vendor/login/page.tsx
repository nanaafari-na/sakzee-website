                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                <input style={{ ...inp, paddingRight: '2.75rem' }} name="password" type={showPassword ? 'text' : 'password'} value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} placeholder="Your password" onKeyDown={e => e.key === 'Enter' && handleLogin()} />
                            ...
                            <div style={{ textAlign: 'right', marginTop: '0.4rem' }}>
                                <Link href="/vendor/forgot-password" style={{ color: '#9ca3af', fontSize: '0.8rem', textDecoration: 'none' }}>Forgot password?</Link>
                            </div>
                        </div>

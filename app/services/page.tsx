...
const services = [
    ...
    },
    {
        ...
        desc: 'From receiving orders to packed and shipped — we handle picking, packing, labeling and dispatch. Returns are fully managed including inspection, restocking and customer refunds.',
        ...
        embedded: {
            title: 'Returns Management — included',
            features: ['Return labels generated', 'Item inspection & assessment', 'Automatic restocking', 'Refund processing support'],
        },
        cta: 'Get Started',
